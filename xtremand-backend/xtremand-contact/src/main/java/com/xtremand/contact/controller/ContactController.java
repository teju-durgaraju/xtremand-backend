...
public class ContactController {
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "File uploaded and contacts saved successfully"),
			@ApiResponse(responseCode = "400", description = "Bad Request - File is missing, empty, or has an unsupported format", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.xtremand.common.dto.ErrorResponse.class))) })
	...
	public ResponseEntity<Response> uploadFile(
		...
		contactService.save(file, skipHeader, isListCreate, listName);
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "List created successfully"),
			@ApiResponse(responseCode = "400", description = "Bad Request - Invalid input data", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.xtremand.common.dto.ErrorResponse.class))) })
	@PostMapping
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "List updated successfully"),
			@ApiResponse(responseCode = "400", description = "Bad Request - Invalid input data", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.xtremand.common.dto.ErrorResponse.class))),
			@ApiResponse(responseCode = "404", description = "Not Found - Contact list not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.xtremand.common.dto.ErrorResponse.class))) })
	@PutMapping("/{id}")
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "List deleted successfully"),
			@ApiResponse(responseCode = "404", description = "Not Found - Contact list not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.xtremand.common.dto.ErrorResponse.class))) })
	@DeleteMapping("/{id}")
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Contacts added successfully"),
			@ApiResponse(responseCode = "400", description = "Bad Request - Contact already in list", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.xtremand.common.dto.ErrorResponse.class))),
			@ApiResponse(responseCode = "404", description = "Not Found - Contact list or one of the contacts not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.xtremand.common.dto.ErrorResponse.class))) })
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Contact removed successfully"),
			@ApiResponse(responseCode = "404", description = "Not Found - Contact list or contact not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.xtremand.common.dto.ErrorResponse.class))) })
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Successfully retrieved data"),
			@ApiResponse(responseCode = "404", description = "Not Found - Contact list not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.xtremand.common.dto.ErrorResponse.class))) })
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Successfully retrieved contact"),
			@ApiResponse(responseCode = "404", description = "Not Found - Contact not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.xtremand.common.dto.ErrorResponse.class))) })
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Contact created successfully"),
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Contact updated successfully"),
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "Contact deleted successfully"),
			@ApiResponse(responseCode = "404", description = "Contact not found") })
