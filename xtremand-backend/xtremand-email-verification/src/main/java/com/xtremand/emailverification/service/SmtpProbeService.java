...
import com.xtremand.emailverification.config.SmtpVerificationProperties;
import com.xtremand.emailverification.domain.EmailVerificationHistory.SmtpCheckStatus;
import com.xtremand.emailverification.domain.EmailVerificationHistory.SmtpPingStatus;
import com.xtremand.emailverification.model.SmtpProbeResult;
import com.xtremand.emailverification.service.verifier.MxCheckProvider;
...
public class SmtpProbeService {
    ...
    private SmtpProbeResult performSmtpCheck(String email, String mxHost, StringBuilder sessionLogs) throws IOException {
        ...
        try {
            ...
            int rcptToReply = client.sendRCPT(email);
            ...
            } else if (SMTPReply.isTransient(rcptToReply)) {
