...
public class CustomLoginAuthenticationProviderTest {
    ...
    @Test
    public void testAuthenticate_whenUserIsUnapproved_throwsAccountUnapprovedException() {
        ...
        when(userLookupService.findByEmail("test@example.com")).thenReturn(Optional.of(user));

        UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken("test@example.com", "password");
    ...
    @Test
    public void testAuthenticate_whenUserIsSuspended_throwsAccountSuspendedException() {
        AuthUserDto user = AuthUserDto.builder()
                .email("test@example.com")
                .passwordHash("password")
    ...
    @Test
    public void testAuthenticate_whenUserIsDeactivated_throwsAccountDeletedException() {
        AuthUserDto user = AuthUserDto.builder()
                .email("test@example.com")
                .passwordHash("password")
    ...
    @Test
    public void testAuthenticate_whenPasswordIsInvalid_throwsBadCredentialsException() {
        AuthUserDto user = AuthUserDto.builder()
                .email("test@example.com")
                .passwordHash("password")
        ...
        UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken("test@example.com", "wrong_password");
