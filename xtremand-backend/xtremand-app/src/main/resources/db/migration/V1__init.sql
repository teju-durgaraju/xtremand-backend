CREATE TABLE xt_role (
    ...
    CONSTRAINT uk_xt_role_name UNIQUE (name)
);

CREATE INDEX idx_xt_role_created_at ON xt_role (created_at);
CREATE INDEX idx_xt_role_updated_at ON xt_role (updated_at);
...
CREATE TABLE xt_users (
    ...
    created_by VARCHAR(255),
    updated_by VARCHAR(255),
    CONSTRAINT fk_xt_users_role FOREIGN KEY (role_id) REFERENCES xt_role(id),
...
INSERT INTO xt_role (name) VALUES ('SUPER_ADMIN'), ('ADMIN'), ('TEAM_MEMBER');
